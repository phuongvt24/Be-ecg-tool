from pretrain.eval import classify
...
class MetaNN(nn.Module):
    def __init__(self, input_size, output_size):
        ...
        self.attention = SelfAttention1D(input_size)
...
best_model_path = './pretrain/ptbxl/checkpoints/best_meta_model_2.pt'
...
def predict_fusion_att(x,y):
    ...
    output_size = test_y_trues.shape[1]
